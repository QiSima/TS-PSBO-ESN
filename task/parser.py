...
def get_parser(parsing = True):
    ...
    # -----------------------------------------------------------------------------------
    # Model name
    parser.add_argument('-model', type=str, default='psb_esn', help='name of the implemented model')


    # -----------------------------------------------------------------------------------
    # dataset location parameters
    parser.add_argument('-datafolder', type=str, default='', help='folder name of the dataset')
    parser.add_argument('-dataset', type=str, default='gef_iso',help='file name of the dataset')
